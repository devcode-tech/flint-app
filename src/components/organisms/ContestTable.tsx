    ...
    <div className="flex flex-col items-start w-full bg-white rounded-2xl shadow-sm overflow-hidden">
      ...
      <div className="w-full overflow-x-auto">
        <div className="min-w-[1200px]">
          {/* Table Header */}
          <div className="flex items-stretch w-full h-12 bg-[#F9FAFB]">
            <div className="flex px-5 items-center gap-1 w-24 flex-shrink-0 border-r border-[#E4E7EC]">
              <div className="text-[#344051] text-sm font-semibold leading-5">
                Status
              </div>
            </div>
            <div className="flex flex-1 px-5 items-center gap-1 min-w-[180px] border-r border-[#E4E7EC]">
              <div className="text-[#344051] text-sm font-semibold leading-5">
                Name
              </div>
            </div>
            <div className="flex px-5 items-center gap-1 w-32 flex-shrink-0 border-r border-[#E4E7EC]">
              <div className="text-[#344051] text-sm font-semibold leading-5">
                Start Date
              </div>
            </div>
            ...
            <div className="flex px-5 items-center gap-1 w-28 flex-shrink-0 border-r border-[#E4E7EC]">
              <div className="text-[#344051] text-sm font-semibold leading-5">
                Impression
              </div>
            </div>
            ...
            <div className="flex w-24 px-5 items-center justify-center gap-1 flex-shrink-0">
              <div className="text-[#344051] text-sm font-semibold leading-5">
                Actions
              </div>
            </div>
          ...
          {contests.map((contest, index) => (
            <div key={contest.id} className={cn("flex items-stretch w-full relative hover:bg-[#F9FAFB] transition-colors border-b border-[#E4E7EC] last:border-b-0", index % 2 === 0 ? "bg-white" : "bg-[#FAFBFC]")}>
              {/* Status Column */}
              <div className="flex w-24 px-5 py-4 items-center gap-1.5 flex-shrink-0 border-r border-[#E4E7EC]">
                <ToggleSwitch
              ...
              {/* Name Column */}
              <div className="flex flex-1 px-5 py-4 items-center gap-2.5 min-w-[180px] border-r border-[#E4E7EC]">
                <button
                  onClick={() => handleViewContest(contest.id)}
                  className="flex flex-col justify-center items-start min-w-0 text-left hover:opacity-80 transition-opacity w-full"
                >
                  <div className="text-[#141C25] text-sm font-semibold leading-5 break-words w-full hover:text-[#005EB8] transition-colors">
                    {contest.name}
                  </div>
                </button>
              </div>
              ...
              {/* Start Date Column */}
              <div className="flex w-32 px-5 py-4 items-center gap-2.5 flex-shrink-0 border-r border-[#E4E7EC]">
                <div className="text-[#637083] text-sm font-medium leading-5">
                  {contest.start_date ? new Date(contest.start_date).toLocaleDateString() : '-'}
                </div>
              </div>
              ...
              {/* Impression Column */}
              <div className="flex w-28 px-5 py-4 items-center gap-2.5 flex-shrink-0 border-r border-[#E4E7EC]">
                <div className="text-[#637083] text-sm font-medium leading-5">
              ...
              {/* Actions Column */}
              <div className="flex w-24 px-5 py-4 justify-center items-center gap-3 flex-shrink-0">
                <button
                  onClick={() => handleViewContest(contest.id)}
